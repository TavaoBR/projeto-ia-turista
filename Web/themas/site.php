...
<head>
  ...
  <!-- Main CSS File -->
  <link href="<?=Assests("/")?>assets/css/main.css" rel="stylesheet">
...
<body class="index-page">
  ...
  <script src="<?=Assests("/")?>assets/vendor/aos/aos.js"></script>
  <script src="<?=Assests("/")?>assets/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="<?=Assests("/")?>assets/vendor/swiper/swiper-bundle.min.js"></script>
